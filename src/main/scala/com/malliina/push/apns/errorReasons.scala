...
case object PayloadTooLarge extends APNSError("PayloadTooLarge", "The message payload was too large. The maximum payload size is 4096 bytes.")
case object BadTopic extends APNSError("BadTopic", "The apns-topic was invalid.")
case object TopicDisallowed extends APNSError("TopicDisallowed", "Pushing to this topic is not allowed.")
case object BadMessageId extends APNSError("BadMessageId", "The apns-id value is bad.")
case object BadExpirationDate extends APNSError("BadExpirationDate", "The apns-expiration value is bad.")
case object BadPriority extends APNSError("BadPriority", "The apns-priority value is bad.")
case object MissingDeviceToken extends APNSError("MissingDeviceToken", "The device token is not specified in the request :path. Verify that the :path header contains the device token.")
case object BadDeviceToken extends APNSError("BadDeviceToken", "The specified device token was bad. Verify that the request contains a valid token and that the token matches the environment.")
case object DeviceTokenNotForTopic extends APNSError("DeviceTokenNotForTopic", "The device token does not match the specified topic.")
case object Unregistered extends APNSError("Unregistered", "The device token is inactive for the specified topic.")
case object DuplicateHeaders extends APNSError("DuplicateHeaders", "One or more headers were repeated.")
case object BadCertificateEnvironment extends APNSError("BadCertificateEnvironment", "The client certificate was for the wrong environment.")
...
case object MethodNotAllowed extends APNSError("MethodNotAllowed", "The specified :method was not POST.")
case object TooManyRequests extends APNSError("TooManyRequests", "Too many requests were made consecutively to the same device token.")
...
case object InternalServerError extends APNSError("InternalServerError", "An internal server error occurred.")
